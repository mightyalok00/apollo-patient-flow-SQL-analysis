          ...
          <div className="flex items-center space-x-2 pl-2">
            {onOpenDiagnostics && (
              <button
                ...
                className="flex items-center space-x-1.5 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-300 hover:text-emerald-200 px-2.5 py-0.5 rounded-md border border-emerald-500/30 text-[11px] font-semibold transition-colors cursor-pointer"
                title="System Health & Efficiency Diagnostics"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping"></span>
                <span>⚡ Latency: 1.8ms • Grade A+</span>
              </button>
            )}
          </div>
        </div>
